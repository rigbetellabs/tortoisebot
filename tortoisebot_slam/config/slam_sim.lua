...
TRAJECTORY_BUILDER_2D.real_time_correlative_scan_matcher.angular_search_window = math.rad(12.0)
...
TRAJECTORY_BUILDER_2D.ceres_scan_matcher.rotation_weight = 25.0
